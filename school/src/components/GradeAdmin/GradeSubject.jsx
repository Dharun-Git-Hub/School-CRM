    ...
    return (
        <div style={{border: '1px solid #ccc', padding: 10, marginBottom: 10}}>
            ...
            <div style={{margin: '10px 0'}}>
                {grades.filter(e=>e===myGrade).map((grade, index)=>(
...
const GradeSubject = ({myGrade}) => {
    ...
    const handleUpload = async() => {
        try{
            ...
            const response = await fetch('http://localhost:3000/grade/uploadExcel',{
                method: 'POST',
                body: formData,
            })
            const data = await response.json()
    ...
    const addSubject = async () => {
        ...
        try{
            ...
            const response = await fetch('http://localhost:3000/grade/uploadManual',{
                method: 'POST',
